...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: uc2.php"); // Redirect to uc2.php
    exit(); 
}
?>
<!DOCTYPE html>
            ...
            <div class="row uc-card">
                ...
                <div class="col-12 uc-card-content">
                    ...
                    <form class="text-center" method="POST">
                        <label for="fname" class="uc-label">First name:</label><br />
                        <input class="uc-input" id="fname" name="fname" type="text" required><br /><br />
                        <label for="lname" class="uc-label">Last name:</label><br />
                        <input class="uc-input" id="lname" name="lname" type="text"><br />
